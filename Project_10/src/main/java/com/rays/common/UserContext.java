...
public class UserContext {
	...
	public UserContext(UserDTO dto) {
		...
		/*
		 * if (roles == null && userDTO != null) { roles = new HashSet<String>();
		 * Iterator<UserRoleDTO> it = userDTO.getUserRoles().iterator(); while
		 * (it.hasNext()) { roles.add(it.next().getRoleName()); } }
		 */
